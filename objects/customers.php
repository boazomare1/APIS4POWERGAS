...
AND NOT EXISTS
  (SELECT *
   ...
   sma_vehicles.id = ? and sma_customers.active = 1 and sma_allocation_days.day = ? and sma_allocation_days.duration > 0 and sma_vehicle_route.day = ? and sma_allocation_days.salesman_id = ? and 
